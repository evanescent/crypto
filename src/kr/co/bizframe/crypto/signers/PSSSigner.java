...
public class PSSSigner implements Signer {
	...
	public byte[] generateSignature() throws CryptoException,
		...
		if (sLen != 0) {
			...
			//String ss = "dee959c7e06411361420ff80185ed57f3e6776af";
			//salt = ByteUtil.toByteArray(ss);
