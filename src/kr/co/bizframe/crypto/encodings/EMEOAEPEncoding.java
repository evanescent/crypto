...
/**
 * EME- Optimal Asymmetric Encryption Padding (OAEP) - see PKCS 1 V 2.
 */
public class EMEOAEPEncoding implements AsymmetricBlockCipher {
	...
	public EMEOAEPEncoding(AsymmetricBlockCipher cipher) {
		this(cipher, new SHA1Digest(), null);
	}

	public EMEOAEPEncoding(AsymmetricBlockCipher cipher, Digest hash) {
	...
	private byte[] encodeBlock(byte[] in, int inOff, int inLen)
		...
		System.out.println("xxx =" + ByteUtil.toHexString(block));
		//
		// generate the seed.
		//
		...
		// for test vector
		//String ss = "aafd12f659cae63489b479e5076ddec2f06cb58f";
		//seed = ByteUtil.toByteArray(ss);
